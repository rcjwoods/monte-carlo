...
#propertiesDict = {'atomicNum':32; 'fano':0; 'energyPerHole':0; 'massDensity':0; 'massAttenuation':0; 'electronMobility':0; 'holeMobility':0; }



def getElementProperties(propertiesDict, energy, temperature):
	...
	if(propertiesDict['atomicNum'] == 32):
		...
		propertiesDict['holeMobility'] = 4.2E4                                      # cm^2/V*s at 77K from G.F.Knoll
